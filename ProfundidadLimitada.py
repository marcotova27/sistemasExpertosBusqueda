...
# Solicitar límite para DLS
limite = int(input("Ingresa el límite de profundidad para la búsqueda DLS: "))

# Ejecuta la búsqueda DLS
camino, distancia = grafo.dls(inicio, objetivo, limite)

if camino:
    print(f"\nCamino DLS de {inicio} a {objetivo} con límite {limite}: {camino}, Distancia: {distancia}")
else:
