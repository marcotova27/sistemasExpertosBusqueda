...
# Búsqueda en profundidad (DFS) con inicio y objetivo diferentes
inicio = 'Parque Revolución'
objetivo = 'Rotonda de los Jaliscienses Ilustres'
camino, distancia = grafo.dfs(inicio, objetivo)
print(f"Camino DFS de {inicio} a {objetivo}: {camino}, Distancia: {distancia}")
